        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h2 className="text-3xl font-bold text-white">Stoddard Numismatics</h2>
            </div>
            <p className="text-slate-400 text-sm ml-10">Rare coin dealer — available coins from our personal inventory</p>
          </div>
          <div className="ml-10 sm:ml-0 flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 rounded-lg px-4 py-2 self-start sm:self-auto">
            <Coins className="w-4 h-4 text-amber-400 flex-shrink-0" />
            <span className="text-amber-300 text-sm font-medium">Curated by a dealer with 20+ years of experience</span>
          </div>
        </div>
      </div>
