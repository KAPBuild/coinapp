...
export const COIN_CATEGORIES: CoinCategory[] = [
  ...
  // Small Cents
  {
    ...
    subcategories: [
      { id: 'flying-eagle', name: 'Flying Eagle', years: '1856-1858', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/1857_Flying_Eagle_Cent.jpg/220px-1857_Flying_Eagle_Cent.jpg', hasKeyDates: true },
      { id: 'indian-head', name: 'Indian Head', years: '1859-1909', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/1859_Indian_Head_Cent.jpg/220px-1859_Indian_Head_Cent.jpg', hasKeyDates: true },
      { id: 'lincoln-wheat', name: 'Lincoln Wheat', years: '1909-1958', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/1909-S_VDB_Lincoln_Cent_Obverse.png/220px-1909-S_VDB_Lincoln_Cent_Obverse.png', hasKeyDates: true },
  ...
  // Nickels
  {
    ...
    subcategories: [
      { id: 'shield-nickel', name: 'Shield', years: '1866-1883', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/1866_Rays_Shield_Nickel.jpg/220px-1866_Rays_Shield_Nickel.jpg', hasKeyDates: true },
      { id: 'liberty-v-nickel', name: 'Liberty (V)', years: '1883-1913', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/1883_Liberty_Head_Nickel.jpg/220px-1883_Liberty_Head_Nickel.jpg', hasKeyDates: true },
      { id: 'buffalo-nickel', name: 'Buffalo', years: '1913-1938', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/1936_Buffalo_Nickel.jpg/220px-1936_Buffalo_Nickel.jpg', hasKeyDates: true },
  ...
  // Dimes
  {
    ...
    subcategories: [
      ...
      { id: 'barber-dime', name: 'Barber', years: '1892-1916', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/1906_dime_obv.jpg/220px-1906_dime_obv.jpg', hasKeyDates: true },
      { id: 'mercury-dime', name: 'Mercury', years: '1916-1945', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/1943D_Mercury_Dime_obverse.jpg/220px-1943D_Mercury_Dime_obverse.jpg', hasKeyDates: true },
  ...
  // Quarters
  {
    ...
    subcategories: [
      ...
      { id: 'barber-quarter', name: 'Barber', years: '1892-1916', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/1901_quarter_obv.jpg/220px-1901_quarter_obv.jpg', hasKeyDates: true },
      { id: 'standing-liberty-quarter', name: 'Standing Liberty', years: '1916-1930', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/1917_Standing_Liberty_quarter_obverse_type_1.jpg/220px-1917_Standing_Liberty_quarter_obverse_type_1.jpg', hasKeyDates: true },
  ...
  // Half Dollars
  {
    ...
    subcategories: [
      ...
      { id: 'barber-half', name: 'Barber', years: '1892-1915', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/1909_half_obv.jpg/220px-1909_half_obv.jpg', hasKeyDates: true },
      { id: 'walking-liberty-half', name: 'Walking Liberty', years: '1916-1947', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Walking_Liberty_Half_Dollar_1945D_Obverse.png/220px-Walking_Liberty_Half_Dollar_1945D_Obverse.png', hasKeyDates: true },
  ...
  // Dollars
  {
    ...
    subcategories: [
      ...
      { id: 'draped-bust-dollar', name: 'Draped Bust', years: '1795-1804', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Draped_Bust_dollar.jpg/220px-Draped_Bust_dollar.jpg', hasKeyDates: true },
      ...
      { id: 'morgan-dollar', name: 'Morgan Dollar', years: '1878-1921', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/1878S_Morgan_Dollar_NGC_MS64plus_Obverse.png/220px-1878S_Morgan_Dollar_NGC_MS64plus_Obverse.png', hasKeyDates: true },
      { id: 'peace-dollar', name: 'Peace Dollar', years: '1921-1935', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Peace_dollar.jpg/220px-Peace_dollar.jpg', hasKeyDates: true },
  ...
  // Gold Coins
  {
    ...
    subcategories: [
      ...
      { id: 'half-eagle', name: 'Half Eagle ($5)', years: '1795-1929', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/1911_Indian_Head_half_eagle_obverse.jpg/220px-1911_Indian_Head_half_eagle_obverse.jpg', hasKeyDates: true },
      { id: 'eagle', name: 'Eagle ($10)', years: '1795-1933', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/1926_eagle_obv.jpg/220px-1926_eagle_obv.jpg', hasKeyDates: true },
      { id: 'double-eagle', name: 'Double Eagle ($20)', years: '1849-1933', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/1924_Saint-Gaudens_double_eagle_obverse.jpg/220px-1924_Saint-Gaudens_double_eagle_obverse.jpg', hasKeyDates: true },
    ]
  },
